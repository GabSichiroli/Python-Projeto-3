...
def cadastro_voo(dict_voos,listavoos_disponiveis):
    ...
    for i in range(quant):
        ...
        while cidadedestino.isdigit() or cidadedestino.isspace() or cidadedestino=="" or cidadedestino==cidadeorigem:
            print(f'Cidade Inválida')
...
def venda_passagem(dict_voos, dict_passageiros,lista_voosdisponiveis):
        ...
        if dict_voos[voo_escolhido][4] >=num_passagens:
...
while True:
    ...
    match opcao:
        case 1:
            cadastro_voo(voos, voos_disponiveis)
        case 2:
            while True:
